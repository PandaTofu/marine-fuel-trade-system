    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_prefix', models.CharField(default='BD', max_length=12)),
            ],
        ),
        migrations.CreateModel(
            name='LoginGuard',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('operator', 'Operator')], default='operator', max_length=12)),
                ('language', models.CharField(choices=[('zh-CN', '中文'), ('en', 'English')], default='zh-CN', max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('customer', 'Customer'), ('supplier', 'Supplier'), ('oil', 'Oil'), ('port', 'Port'), ('salesperson', 'Salesperson')], max_length=16)),
